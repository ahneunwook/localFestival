...
export function HomePage() {
  return `
    ...
    <main class="hero-section">
      ...
      <div class="info-grid">
        <div class="info-card" onclick="location.href='/festivals?status=ongoing'">
          <div class="icon">
        ...
        <div class="info-card" onclick="location.href='/festivals?sort=popular'">
          <div class="icon">
        ...
        <div class="info-card" onclick="location.href='/festivals?view=map'">
          <div class="icon">
        ...
        <div class="info-card" onclick="location.href='/calendar'">
          <div class="icon">
        ...
        <div class="info-card" onclick="location.href='/festivals?sort=newest'">
          <div class="icon">
        ...
        <div class="info-card" onclick="location.href='/reviews'">
          <div class="icon">
